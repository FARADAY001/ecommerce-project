	...
	<div class="container-full">
	 ...
	 <tr>
		<td> <img src="{{ asset($item->product_thambnail) }}" style="width: 60px; height: 50px;">  </td>
		 ...
		 <td>
			@if($item->discount_price == NULL)
		 	<span class="badge badge-pill badge-danger">Pas de remise</span>
		...
		<td width="30%">
            ...
            <a href="{{ route('product.edit',$item->id) }}" class="btn btn-info" title="Editer des données"><i class="fa fa-pencil"></i> </a>
