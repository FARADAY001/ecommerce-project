...
<div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select name="brand_id" class="form-control" required="" >
                                    <option value="" selected="" disabled="">Choisir la marque</option>
    ...
    <div class="row"> <!-- start 2nd row  -->
        <div class="col-md-4">
            ...
            <div class="form-group">
                <h5> Sélectionner Sous-sous-catégorie <span class="text-danger">*</span></h5>
                <div class="controls">
                    <select name="subsubcategory_id" class="form-control"  required=""  >
                        <option value="" selected="" disabled="">Sélectionner une sous-sous-catégorie</option>
                    </select>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <h5>Nom du produit français <span class="text-danger">*</span></h5>                       
                <div class="controls">
    ...
    <div class="row"> <!-- start 3RD row  -->
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <h5>Quantité du produit <span class="text-danger">*</span></h5>
                <div class="controls">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <h5>Tags du produit En<span class="text-danger">*</span></h5>
                <div class="controls">
    ...
    <div class="row"> <!-- start 4th row  -->
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <h5>Tags du produit fr<span class="text-danger">*</span></h5>
                <div class="controls">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" name="product_size_fr" class="form-control" value="Petit,Moyen,Grand" data-role="tagsinput" required="">
    ...
    <div class="row"> <!-- start 5th row  -->
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" name="product_color_fr" class="form-control" value="rouge,noir,blanc" data-role="tagsinput" required="">
    ...
    <div class="row"> <!-- start 6th row  -->
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <h5>Prix de réduction Produit<span class="text-danger">*</span></h5>
                <div class="controls">
...
<div class="row"> <!-- start 7th row  -->
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <h5>Brève description Anglais<span class="text-danger">*</span></h5>
            <div class="controls">
                <textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Description"></textarea>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <h5>Brève description Français<span class="text-danger">*</span></h5>
            <div class="controls">
                <textarea name="short_descp_fr" id="textarea" class="form-control" required placeholder="Description"></textarea>
            </div>
        </div>
...
<div class="row"> <!-- start 8th row  -->
    ...
    <div class="col-md-6">
        <div class="form-group">
            <h5>Description détaillée Anglais<span class="text-danger">*</span></h5>
            <div class="controls">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <h5>Description détaillée Français<span class="text-danger">*</span></h5>
            <div class="controls">
  ...
  $(document).ready(function(){
   $('#multiImg').on('change', function(){ //on file input change
      if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
      {
          ...
          alert("Votre navigateur ne prend pas en charge l'API Fichier !"); //if File API is absent
      }
   });
  });
