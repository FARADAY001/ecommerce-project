...
<div class="container-full">
    ...
    <section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Modifier le produit </h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			    <div class="row">
        ...
        <div class="row">
                ...
                <div class="row"> <!-- start 1st row  -->
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <h5>Sélectionner la marque <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <select name="brand_id" class="form-control" required="" >
                                    <option value="" selected="" disabled="">Sélectionner la marque</option>
                                    @foreach($brands as $brand)
                            <option value="{{ $brand->id }}" {{ $brand->id == $products->brand_id ? 'selected': '' }} >{{ $brand->brand_name_fr }}</option>	
                                    @endforeach
                                </select>
                                @error('brand_id') 
				...
				<div class="form-group">
                    ...
                    <div class="controls">
                        <select name="category_id" class="form-control" required="" >
                            ...
                            <option value="{{ $category->id }}" {{ $category->id == $products->category_id ? 'selected': '' }} >{{ $category->category_name_fr }}</option>	
                            @endforeach
                        </select>
                        @error('category_id') 
                    <span class="text-danger">{{ $message }}</span>
			...
			<div class="col-md-4">
			<div class="form-group">
                <h5>Choix de la sous-catégorie <span class="text-danger">*</span></h5>
                <div class="controls">
                    <select name="subcategory_id" class="form-control" required="" >
                        <option value="" selected="" disabled="">Choix de la sous-catégorie</option>

                        @foreach($subcategory as $sub)
                        <option value="{{ $sub->id }}" {{ $sub->id == $products->subcategory_id ? 'selected': '' }} >{{ $sub->subcategory_name_fr }}</option>	
                        @endforeach
    ...
    <div class="col-md-4">
	<div class="form-group">
        <h5>Sélectionnez Sous-sous-catégorie <span class="text-danger">*</span></h5>
        <div class="controls">
            <select name="subsubcategory_id" class="form-control" required="" >
                <option value="" selected="" disabled="">Sélectionnez Sous-sous-catégorie </option>

            @foreach($subsubcategory as $subsub)
            <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_fr }}</option>	
                @endforeach
	...
	<div class="col-md-4">
	<div class="form-group">
		<h5>Nom produit An <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="row"> <!-- start 3RD row  -->
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Tags produit An <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 4th row  -->
	 ...
	 @enderror
            ...
            <div class="form-group">
                <h5>Taille du produit An <span class="text-danger">*</span></h5>
                <div class="controls">
			...
			<div class="controls">
	 <input type="text" name="product_size_hin" class="form-control" value="{{ $products->product_size_fr }}" data-role="tagsinput" required="">
    ...
    <div class="row"> <!-- start 5th row  -->
	    ...
	    <div class="form-group">
			<h5>Couleur produit An <span class="text-danger">*</span></h5>
			<div class="controls">
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Couleur produit Fr <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 6th row  -->
    ...
    <div class="col-md-6">
	    ...
	    <div class="form-group">
			<h5> Prix de réduction <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			<h5>Courte Description An <span class="text-danger">*</span></h5>
			<div class="controls">
	     ...
	     <div class="form-group">
			<h5>Courte Description Fr <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			<h5> Longue Description An <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="col-md-6">
		...
		<div class="controls">
			<fieldset>
				...
				<label for="checkbox_2">Promotions</label>
			</fieldset>
			<fieldset>
            ...
            <div class="controls">
                ...
                <fieldset>
                    ...
                    <div class="text-xs-right">
                        <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Mise à jour du produit">
                    </div>
                </form>
        ...
        <div class="col-md-12">
            <div class="box bt-3 border-info">
                <div class="box-header">
                    <h4 class="box-title">Mise à jour des images multiples <strong> des produits</strong></h4>
                </div>
                <form method="post" action="{{ route('update-product-image') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> 
                                        <div class="form-group">
                                            <label class="form-control-label"> Changer d'image <span class="tx-danger">*</span></label>
                    ...
                    <div class="text-xs-right">
                        <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Actualiser l'image">
                    </div>
                    <br><br>
                </form>		   
            </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
               <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4 class="box-title">Mise à jour de l'image<strong>principale</strong>  du produit </h4>
                    </div>
  ...
  $(document).ready(function(){
   $('#multiImg').on('change', function(){ //on file input change
      if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
      {
          ...
          alert("Votre navigateur ne prend pas en charge l'API Fichier !"); //si l'API Fichier est absente
      }
   });
  });
