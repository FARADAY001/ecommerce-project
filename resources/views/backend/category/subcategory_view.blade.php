		    ...
		    <div class="row">
			    ...
			    <div class="col-8">
                    ...
                    <div class="box">
                        ...
                        <h3 class="box-title">Liste des sous-catégories</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Catégories </th>
                                            <th>Sous-catégorie En</th>
                                            <th>Sous-catégorie fr </th>
                                            <th>Action</th>
...
<!--   ------------ Add Category Page -------- -->
 ...
 <form method="post" action="{{ route('subcategory.store') }}" >
        ...
        <div class="form-group">
            <h5>Sélection de la catégorie <span class="text-danger">*</span></h5>
            <div class="controls">
