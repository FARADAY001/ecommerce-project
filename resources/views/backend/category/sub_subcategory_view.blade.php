			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Sous->Sous-catégorie</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th>Sous-sous-catégorie Français </th>
								<th>Action</th>
							</tr>
						</thead>
						<tbody>
...
<!--   ------------ Add Category Page -------- -->
        ...
        <div class="col-4">
			<div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Ajouter sous-sous-catégorie</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
                ...
                <form method="post" action="{{ route('subsubcategory.store') }}" >
	 	            @csrf
                        ...
                        <div class="form-group">
                            <h5>Choix de catégorie <span class="text-danger">*</span></h5>
                            <div class="controls">
